...
# -------------------------------------------
# This script installs all pre-requisites necessary to run the RDP monitoring tool.
# Save this script as "install-prerequisites.ps1"
...
# ------------------------
# To run the RDP monitoring tool, follow the process below:
#
